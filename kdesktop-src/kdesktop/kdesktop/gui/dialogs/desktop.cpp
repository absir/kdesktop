...
tdesktop::tdesktop(const trdpcookie& rdpcookie)
	...
	// , notch_size_(game_config::os != os_windows? SDL_GetNotchSizeRose(): SDL_Point{8 * twidget::hdpi_scale, 4 * twidget::hdpi_scale})
	, notch_size_(game_config::os != os_windows? SDL_GetNotchSizeRose(): SDL_Point{16 * twidget::hdpi_scale, 8 * twidget::hdpi_scale})
...
void tdesktop::rexplorer_pre_show(twindow& window)
{
	...
	main_stack_->set_did_pip_top_grid_rect(*explorer_grid_, boost::bind(&tdesktop::did_pip_top_grid_rect, this, _1, _2, _3, _4));
...
void tdesktop::rdp_paste(net::RdpClientRose& rdpc, const std::string& path)
{
	...
	tprogress_default_slot slot(boost::bind(&net::RdpClientRose::hdrop_paste, &rdpc, _1, path, &err_code, err_msg, sizeof(err_msg)),
